...
btn_clear=tk.Button(window,text="clear",command=clear, font=("Times New Roman",14))
...
btn_parenthesis=tk.Button(window,text="(",command=lambda:add_to_field("("),width=5,font=("Times New Roman",14))
btn_parenthesis.grid(row=6,column=1)
